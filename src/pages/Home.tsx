        ...
        <div className="w-full max-w-[1200px] flex flex-col gap-[48px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
            <FocusCardFramerComponent.Responsive
              ...
              icon={{ src: '/images/framer/iiQwBNQcCcDi7J5sN4aFs0RI0Mg.png', alt: 'Energy & Water' }}
            ...
            <FocusCardFramerComponent.Responsive
              ...
              icon={{ src: '/images/framer/36NIpLGjIHMIAr8We5YC8ZO2PJQ.png', alt: 'Hazards & Risk' }}
              style={{ width: '100%', height: '377px' }}
            />
            <FocusCardFramerComponent.Responsive
              ...
              icon={{ src: '/images/framer/KnKOoD9a8xaIeLqTcXaGnkasHOA.png', alt: 'Adaptation Solutions' }}
              style={{ width: '100%', height: '377px' }}
            />
            <FocusCardFramerComponent.Responsive
              title="Policy Engagement"
              overview="Bridging science and policy to strengthen climate-resilient decision-making."
              icon={{ src: '/images/framer/he2V1ICax9WCiGgQtFUx05UhM0I.png', alt: 'Policy Engagement' }}
              style={{ width: '100%', height: '377px' }}
            />
          </div>
        </div>
